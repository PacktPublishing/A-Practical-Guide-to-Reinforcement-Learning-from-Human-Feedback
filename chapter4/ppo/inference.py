...
if __name__ == "__main__":
    ...
    # Initialize a vectorized environment with num_envs=1 for single inference or initialize a single environment directly
    ...
    if run_inference:
        ...
        checkpoint = load_model(agent, 'checkpoints/ppo_checkpoint_90.pth') # Assuming 'checkpoints/ppo_checkpoint_90.pth' is the saved model to inference
        # Run inference
